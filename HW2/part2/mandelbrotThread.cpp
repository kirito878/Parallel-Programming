...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    // int start = args->threadId * height;
    // mandelbrotSerial(args->x0, args->y0, args->x1, args->y1, args->width, args->height, start, height, args->maxIterations, args->output);
    
    int numThreads = args->numThreads;
    int height = args->height;
    for (int i = args->threadId;i < height;i+= numThreads){
